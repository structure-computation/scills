...
DIR_SOURCES_MPI = -I/usr/lib/openmpi -I/usr/lib/openmpi/include
OPT = -ne -j1 -O1 -ffast-math -fexpensive-optimizations
...
metil_comp_multi :
	$(LOC_MC)  -o  $(PRG_multi) -DCPU  -DDIM=$(DIM) -DCPU  -DTYPE=double -DTYPEREEL=double  -DLDL -Dcrout_alain $(DIR_SOURCES_LMT) $(DIR_SOURCES_MPI) $(DIR_SOURCES_SC) $(DIR_SOURCES_GEOMETRY)  $(DIR_build_cpu) $(CFLAGS) $(LIBS) $(OPT)  src/multiscale.cpp
