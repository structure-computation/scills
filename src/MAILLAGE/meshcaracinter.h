#ifndef LMT___SRC_MAILLAGE_MESHCARACINTER_MESHCARAC_PY
#define LMT___SRC_MAILLAGE_MESHCARACINTER_MESHCARAC_PY
...
#ifndef IFNDEF_group_id_DM
#define IFNDEF_group_id_DM
    struct group_id_DM {};
#endif // IFNDEF_group_id_DM
...
public:
    ...
    struct TCDM0 {
        TCDM0():type(0),num(0),F(0),W(0),dWn(0),dWt(0),dissipation(0),d(0),group_id(0) {}
        CARACDMEXTNAME(0,double,type,"");
        CARACDMEXTNAME(1,unsigned,num,"");
        typedef Vec<unsigned> T2;
        CARACDMEXTNAME(2,T2,elem,"");
        typedef Vec<double,1> T3;
        CARACDMEXTNAME(3,T3,F,"Mpa");
        typedef Vec<double,1> T4;
        CARACDMEXTNAME(4,T4,W,"m/s");
        typedef Vec<double,1> T5;
        CARACDMEXTNAME(5,T5,dWn,"m/s");
        typedef Vec<double,1> T6;
        CARACDMEXTNAME(6,T6,dWt,"m/s");
        typedef Vec<double,1> T7;
        CARACDMEXTNAME(7,T7,dissipation,"J");
        CARACDMEXTNAME(8,double,d,"");
        CARACDMEXTNAME(9,double,group_id,"");
...
#endif // LMT___SRC_MAILLAGE_MESHCARACINTER_MESHCARAC_PY
