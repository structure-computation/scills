...
df = Variable( interpolation='elementary', default_value='0', unit='' )
d1 = Variable( interpolation='elementary', default_value='0', unit='' )
d2 = Variable( interpolation='elementary', default_value='0', unit='' )
...
def formulation():
    ...
    K0,H0,epsth0,P0 =  hooke_orthotrope_th_3d_endo(elastic_modulus_1.expr,elastic_modulus_2.expr,elastic_modulus_3.expr,
                                                    ...
                                                    v1.expr,v2.expr,
                                                    alpha_1.expr,alpha_2.expr,alpha_3.expr,
                                                    d1.expr,d2.expr,df.expr)
