...
template<class TV1, class TV2> void assignation_materials_property_SST(DataUser &data_user, TV1 &S, TV2 &Inter,Param &process, FieldStructureUser &field_structure_user) __attribute__((noinline));
template<class TV1, class TV2> void assignation_materials_property_INTER(DataUser &data_user, TV2 &Inter, TV1 &S, Param &process, FieldStructureUser &field_structure_user) __attribute__((noinline));
...
template <class TV1,class TV2, class TV3, class TV4, class TV5, class TV6> void multiscale_iterate_incr(TV1 &S,TV2 &SubS, TV3 &Inter, TV4 &SubI, Param &process, TV5 &Global, TV6 &CL, DataUser &data_user, FieldStructureUser &field_structure_user);
