...
template<class TV1, class TV2> void assignation_materials_property_SST(DataUser &data_user, TV1 &S, TV2 &Inter,Param &process) __attribute__((noinline));
template<class TV1, class TV2> void assignation_materials_property_INTER(DataUser &data_user, TV2 &Inter, TV1 &S, Param &process) __attribute__((noinline));
...
template <class TV1, class TV2, class TV3, class TV4>  void multiscale_operateurs(TV1 &S, TV1 &SubS,TV2 &Inter, TV3 &SubI,Param &process,  TV4 &Global) ;
...
template <class TV1,class TV2, class TV3, class TV4, class TV5, class TV6> void multiscale_iterate_incr(TV1 &S,TV2 &SubS, TV3 &Inter, TV4 &SubI, Param &process, TV5 &Global, TV6 &CL);
