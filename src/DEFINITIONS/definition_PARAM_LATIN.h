...
struct LATIN{
    ...
    std::string type_error;  ///< type d'erreur : choix possible entre "ddr" : erreur basée sur les directions de recherche, "energie" : erreur basée sur un calcul d'énergie par interface 
