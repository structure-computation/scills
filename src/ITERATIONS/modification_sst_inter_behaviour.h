...
//                 cout<< "d[j] "   << Inter[i].parammicro->d[j] <<  " dmax " << //Inter[i].parammicro->dmax[j] <<  endl;
                ...
                cout << Inter[i].param_comp->t[1].d << "  "  << Inter[i].param_comp->dmax <<" min " << mind<< endl;

            if(mind<1.-eps){
                Inter[i].param_comp->dmax=Inter[i].param_comp->t[1].d;
                cout << "Interface " << i << " passe pas contact" << endl;
                cout<< "Valeur d apres : " <<  Inter[i].param_comp->t[1].d <<  endl;
                ...
                cout<< "Valeur dmax avant : " <<  Inter[i].param_comp->t[1].dmax <<  endl;
                Inter[i].param_comp->t[1].dmax=Inter[i].param_comp->t[1].d;
                cout<< "Valeur dmax apres : " <<  Inter[i].param_comp->t[1].dmax <<  endl;
            }
        }
    }
