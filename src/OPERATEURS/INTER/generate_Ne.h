...
struct add_elem_Ne{
 ...
 /// pour les Triangle_6
   ...
   double reg0=0.78379396366385999995*e.pos(0)[1]; double reg1=0.56758792732771999991*e.pos(1)[0]; double reg2=0.78379396366385999995*e.pos(0)[0]; double reg3=0.78379396366385999995*e.pos(1)[1]; double reg4=0.56758792732771999991*e.pos(0)[1];
   double reg5=0.56758792732771999991*e.pos(0)[0]; double reg6=0.56758792732771999991*e.pos(1)[1]; double reg7=0.78379396366385999995*e.pos(1)[0]; double reg8=reg7+reg5; double reg9=1.3513818909915799999*e.pos(3)[0];
   double reg10=reg1+reg2; double reg11=1.3513818909915799999*e.pos(3)[1]; double reg12=reg3+reg4; double reg13=0.56758792732771999991*e.pos(0)[2]; double reg14=reg6+reg0;
   double reg15=0.78379396366385999995*e.pos(1)[2]; double reg16=0.56758792732771999991*e.pos(1)[2]; double reg17=0.78379396366385999995*e.pos(0)[2]; double reg18=reg11-reg14; double reg19=reg15+reg13;
   double reg20=1.3513818909915799999*e.pos(3)[2]; double reg21=1.78379396366386*e.pos(4)[1]; reg12=reg12-reg11; double reg22=0.63369514596091600003*e.pos(1)[0]; double reg23=2.2673902919218320001*e.pos(0)[0];
   double reg24=reg9-reg10; double reg25=1.78379396366386*e.pos(4)[0]; reg8=reg8-reg9; double reg26=reg16+reg17; double reg27=0.63369514596091600003*e.pos(1)[1];
   double reg28=2.2673902919218320001*e.pos(0)[1]; reg24=reg25+reg24; double reg29=reg27+reg28; double reg30=0.63369514596091600003*e.pos(0)[1]; double reg31=2.2673902919218320001*e.pos(1)[1];
   reg7=reg7-reg2; double reg32=0.63369514596091600003*e.pos(0)[0]; double reg33=0.43241207267228000009*e.pos(4)[0]; double reg34=0.43241207267228000009*e.pos(4)[1]; reg3=reg3-reg0;
   double reg35=0.63369514596091600003*e.pos(1)[2]; double reg36=2.2673902919218320001*e.pos(0)[2]; double reg37=2.2673902919218320001*e.pos(1)[0]; double reg38=reg20-reg26; double reg39=reg22+reg23;
   reg8=reg8+reg25; double reg40=1.78379396366386*e.pos(5)[0]; double reg41=2.9010854378827480001*e.pos(3)[0]; reg18=reg21+reg18; reg12=reg12+reg21;
   double reg42=1.78379396366386*e.pos(5)[1]; reg19=reg19-reg20; double reg43=1.78379396366386*e.pos(4)[2]; double reg44=2.9010854378827480001*e.pos(3)[1]; double reg45=reg41-reg39;
   double reg46=reg44-reg29; double reg47=0.366304854039084*e.pos(4)[0]; double reg48=0.366304854039084*e.pos(4)[1]; reg3=reg34+reg3; reg15=reg15-reg17;
   double reg49=0.43241207267228000009*e.pos(5)[1]; reg38=reg43+reg38; reg18=reg18-reg42; reg8=reg8-reg40; reg42=reg12-reg42;
   reg19=reg19+reg43; reg12=1.78379396366386*e.pos(5)[2]; double reg50=reg35+reg36; double reg51=2.9010854378827480001*e.pos(3)[2]; double reg52=0.43241207267228000009*e.pos(5)[0];
   reg7=reg7+reg33; double reg53=0.43241207267228000009*e.pos(4)[2]; reg37=reg37+reg32; reg31=reg31+reg30; double reg54=2.2673902919218320001*e.pos(1)[2];
   double reg55=0.63369514596091600003*e.pos(0)[2]; reg40=reg24-reg40; reg15=reg53+reg15; reg24=pow(reg18,2); reg49=reg3-reg49;
   reg52=reg7-reg52; reg3=pow(reg40,2); reg38=reg38-reg12; reg7=0.43241207267228000009*e.pos(5)[2]; reg12=reg19-reg12;
   reg19=reg32-reg22; reg54=reg54+reg55; double reg56=pow(reg42,2); reg31=reg31-reg44; double reg57=0.78379396366385999995*e.pos(2)[0];
   double reg58=pow(reg8,2); reg37=reg37-reg41; double reg59=2.710505431213761085e-20*e.pos(3)[0]; double reg60=0.366304854039084*e.pos(4)[2]; double reg61=0.78379396366385999995*e.pos(2)[1];
   double reg62=reg51-reg50; double reg63=2.710505431213761085e-20*e.pos(3)[1]; double reg64=0.366304854039084*e.pos(5)[1]; reg46=reg46+reg48; double reg65=reg30-reg27;
   double reg66=0.366304854039084*e.pos(5)[0]; reg45=reg45+reg47; double reg67=pow(reg38,2); reg19=reg19-reg59; reg65=reg65-reg63;
   double reg68=reg55-reg35; double reg69=2.710505431213761085e-20*e.pos(3)[2]; double reg70=3.2673902919218320001*e.pos(4)[1]; double reg71=3.2673902919218320001*e.pos(4)[0]; reg54=reg54-reg51;
   reg31=reg48+reg31; reg37=reg47+reg37; double reg72=0.366304854039084*e.pos(5)[2]; reg62=reg62+reg60; reg46=reg46-reg64;
   double reg73=pow(reg52,2); reg45=reg45-reg66; double reg74=pow(reg49,2); double reg75=0.56758792732771999991*e.pos(2)[1]; reg7=reg15-reg7;
   reg15=0.56758792732771999991*e.pos(2)[0]; double reg76=0.78379396366385999995*e.pos(2)[2]; double reg77=1.78379396366386*e.pos(3)[0]; double reg78=reg5+reg57; double reg79=pow(reg12,2);
   double reg80=reg4+reg61; reg56=reg58+reg56; reg24=reg3+reg24; reg3=1.78379396366386*e.pos(3)[1]; reg79=reg56+reg79;
   reg56=0.56758792732771999991*e.pos(2)[2]; reg78=reg78-reg77; reg58=pow(reg46,2); reg80=reg80-reg3; reg62=reg62-reg72;
   reg68=reg68-reg69; reg66=reg37-reg66; reg37=3.2673902919218320001*e.pos(4)[2]; double reg81=3.2673902919218320001*e.pos(5)[1]; reg65=reg70+reg65;
   double reg82=reg0+reg75; double reg83=3.2673902919218320001*e.pos(5)[0]; reg19=reg71+reg19; reg67=reg24+reg67; reg24=pow(reg45,2);
   double reg84=pow(reg7,2); reg54=reg60+reg54; reg57=reg57-reg2; double reg85=0.43241207267228000009*e.pos(3)[0]; reg64=reg31-reg64;
   reg31=1.78379396366386*e.pos(3)[2]; reg74=reg73+reg74; reg73=reg13+reg76; reg0=reg61-reg0; reg61=0.43241207267228000009*e.pos(3)[1];
   double reg86=0.63369514596091600003*e.pos(2)[0]; double reg87=0.63369514596091600003*e.pos(2)[1]; reg2=reg2+reg15; double reg88=1.3513818909915799999*e.pos(5)[0]; double reg89=pow(reg62,2);
   reg72=reg54-reg72; reg79=pow(reg79,0.5); reg54=pow(reg66,2); reg77=reg77+reg2; reg84=reg74+reg84;
   reg74=pow(reg64,2); reg23=reg23+reg86; double reg90=0.366304854039084*e.pos(3)[0]; reg67=pow(reg67,0.5); double reg91=0.63369514596091600003*e.pos(2)[2];
   double reg92=0.366304854039084*e.pos(3)[1]; reg73=reg73-reg31; reg28=reg28+reg87; reg85=reg57-reg85; reg78=reg25+reg78;
   reg61=reg0-reg61; reg0=reg17+reg56; reg17=reg76-reg17; reg80=reg21+reg80; reg83=reg19-reg83;
   reg3=reg3+reg82; reg81=reg65-reg81; reg19=1.3513818909915799999*e.pos(5)[1]; reg68=reg37+reg68; reg57=3.2673902919218320001*e.pos(5)[2];
   reg58=reg24+reg58; reg24=0.43241207267228000009*e.pos(3)[2]; reg25=reg25-reg77; reg65=reg23+reg90; reg21=reg21-reg3;
   reg31=reg31+reg0; reg76=reg28+reg92; double reg93=0.366304854039084*e.pos(3)[2]; reg36=reg36+reg91; reg74=reg54+reg74;
   reg73=reg43+reg73; reg54=2.2673902919218320001*e.pos(2)[1]; reg33=reg85+reg33; reg34=reg61+reg34; reg61=1.3513818909915799999*e.pos(5)[2];
   reg85=2.2673902919218320001*e.pos(2)[0]; reg24=reg17-reg24; reg80=reg80-reg19; reg57=reg68-reg57; reg17=reg18/reg67;
   reg68=pow(reg81,2); double reg94=pow(reg83,2); reg78=reg78-reg88; double reg95=3.2673902919218320001*e.pos(3)[1]; double reg96=reg40/reg67;
   double reg97=reg30-reg87; reg89=reg58+reg89; reg58=3.2673902919218320001*e.pos(3)[0]; double reg98=reg32-reg86; double reg99=pow(reg72,2);
   reg84=pow(reg84,0.5); double reg100=reg8/reg79; double reg101=reg42/reg79; reg73=reg73-reg61; double reg102=reg48-reg76;
   double reg103=reg101*reg80; double reg104=2.9010854378827480001*e.pos(5)[0]; double reg105=reg100*reg78; double reg106=reg47-reg65; reg89=pow(reg89,0.5);
   double reg107=2.2673902919218320001*e.pos(2)[2]; reg67=reg38/reg67; reg54=reg30+reg54; double reg108=reg96*reg33; reg85=reg32+reg85;
   double reg109=reg17*reg34; reg53=reg24+reg53; reg24=pow(reg57,2); reg68=reg94+reg68; reg94=3.2673902919218320001*e.pos(3)[2];
   double reg110=reg55-reg91; reg95=reg97-reg95; reg58=reg98-reg58; reg97=2.9010854378827480001*e.pos(5)[1]; reg99=reg74+reg99;
   reg74=reg36+reg93; reg98=reg52/reg84; double reg111=reg49/reg84; reg79=reg12/reg79; reg25=reg88+reg25;
   reg21=reg19+reg21; reg43=reg43-reg31; reg107=reg55+reg107; reg92=reg54-reg92; reg102=reg102+reg97;
   reg90=reg85-reg90; reg54=reg60-reg74; reg85=2.9010854378827480001*e.pos(5)[2]; reg103=reg105+reg103; reg24=reg68+reg24;
   ...
   reg71=reg58+reg71; reg58=reg46/reg89; reg99=pow(reg99,0.5); reg105=reg45/reg89; reg110=reg79*reg73;
   reg109=reg108+reg109; reg84=reg7/reg84; reg108=reg98*reg25; double reg112=reg111*reg21; reg43=reg61+reg43;
   double reg113=reg67*reg53; reg93=reg107-reg93; reg89=reg62/reg89; reg92=reg48+reg92; reg90=reg47+reg90;
   reg47=reg105*reg106; reg48=reg58*reg102; reg107=reg84*reg43; reg54=reg54+reg85; reg24=pow(reg24,0.5);
   ...
   reg37=reg94+reg37; reg70=reg70-reg68; reg71=reg71-reg95; reg110=reg103+reg110; reg94=reg108*reg71;
   reg103=reg100*reg110; double reg115=reg109*reg70; reg99=reg72/reg99; reg37=reg37-reg114; double reg116=reg101*reg110;
   double reg117=reg17*reg113; double reg118=reg96*reg113; double reg119=reg83/reg24; double reg120=reg81/reg24; double reg121=reg89*reg54;
   reg107=reg112+reg107; reg48=reg47+reg48; reg92=reg92-reg97; reg90=reg90-reg104; reg93=reg60+reg93;
   reg117=reg34-reg117; reg47=reg79*reg110; reg60=reg67*reg113; reg118=reg33-reg118; reg112=reg119*reg90;
   reg93=reg93-reg85; reg24=reg57/reg24; reg116=reg80-reg116; double reg122=reg120*reg92; double reg123=reg99*reg37;
   reg121=reg48+reg121; reg115=reg94+reg115; reg103=reg78-reg103; reg48=reg111*reg107; reg94=reg98*reg107;
   double reg124=pow(reg117,2); double reg125=pow(reg116,2); reg47=reg73-reg47; reg60=reg53-reg60; double reg126=reg84*reg107;
   double reg127=pow(reg118,2); reg48=reg21-reg48; double reg128=pow(reg103,2); reg123=reg115+reg123; reg122=reg112+reg122;
   reg112=reg24*reg93; reg94=reg25-reg94; reg115=reg105*reg121; double reg129=reg58*reg121; reg127=reg124+reg127;
   reg125=reg128+reg125; reg126=reg43-reg126; reg124=pow(reg47,2); reg128=pow(reg60,2); reg115=reg106-reg115;
   ...
   double reg139=pow(reg115,2); reg127=reg128+reg127; reg124=reg125+reg124; reg133=reg131+reg133; reg138=reg37-reg138;
   reg125=pow(reg130,2); reg128=pow(reg132,2); reg134=reg133+reg134; reg131=reg24*reg112; reg135=reg90-reg135;
   ...
   reg128=pow(reg138,2); reg136=pow(reg131,2); reg140=reg139+reg140; reg33=reg33*reg118; reg34=reg34*reg117;
   reg118=reg40*reg118; reg117=reg18*reg117; reg17=reg18*reg17; reg96=reg40*reg96; reg128=reg125+reg128;
   reg127=reg60/reg127; reg124=reg47/reg124; reg78=reg78*reg103; reg80=reg80*reg116; reg100=reg8*reg100;
   reg103=reg8*reg103; reg116=reg42*reg116; reg101=reg42*reg101; reg133=pow(reg133,0.5); reg94=reg94/reg134;
   reg48=reg48/reg134; reg115=reg115/reg133; reg128=pow(reg128,0.5); reg17=reg96+reg17; reg129=reg129/reg133;
   reg111=reg49*reg111; reg67=reg38*reg67; reg98=reg52*reg98; reg25=reg25*reg94; reg80=reg78+reg80;
   reg21=reg21*reg48; reg73=reg73*reg124; reg53=reg53*reg127; reg79=reg12*reg79; reg48=reg49*reg48;
   reg94=reg52*reg94; reg101=reg100+reg101; reg136=reg140+reg136; reg124=reg12*reg124; reg116=reg103+reg116;
   reg127=reg38*reg127; reg117=reg118+reg117; reg34=reg33+reg34; reg134=reg126/reg134; reg106=reg106*reg115;
   reg79=reg101+reg79; reg136=pow(reg136,0.5); reg133=reg122/reg133; reg115=reg45*reg115; reg53=reg34+reg53;
   reg102=reg102*reg129; reg124=reg116+reg124; reg8=reg7*reg134; reg48=reg94+reg48; reg127=reg117+reg127;
   reg105=reg45*reg105; reg134=reg43*reg134; reg58=reg46*reg58; reg129=reg46*reg129; reg73=reg80+reg73;
   reg111=reg98+reg111; reg84=reg7*reg84; reg132=reg132/reg128; reg130=reg130/reg128; reg67=reg17+reg67;
   reg21=reg25+reg21; reg129=reg115+reg129; reg7=reg62*reg133; reg133=reg54*reg133; reg102=reg106+reg102;
   reg89=reg62*reg89; reg58=reg105+reg58; reg134=reg21+reg134; reg8=reg48+reg8; reg128=reg138/reg128;
   reg124=reg110*reg124; reg70=reg70*reg130; reg12=reg66*reg132; reg84=reg111+reg84; reg130=reg64*reg130;
   reg127=reg113*reg127; reg53=reg67*reg53; reg135=reg135/reg136; reg73=reg79*reg73; reg132=reg71*reg132;
   reg137=reg137/reg136; reg108=reg66*reg108; reg109=reg64*reg109; reg37=reg37*reg128; reg70=reg132+reg70;
   reg89=reg58+reg89; reg109=reg108+reg109; reg99=reg72*reg99; reg134=reg84*reg134; reg127=reg53-reg127;
   reg8=reg107*reg8; reg7=reg129+reg7; reg17=reg81*reg137; reg18=reg83*reg135; reg133=reg102+reg133;
   reg124=reg73-reg124; reg135=reg90*reg135; reg119=reg83*reg119; reg137=reg92*reg137; reg120=reg81*reg120;
   reg128=reg72*reg128; reg130=reg12+reg130; reg136=reg131/reg136; reg93=reg93*reg136; reg137=reg135+reg137;
   reg12=0.009463616120767210603*reg127; reg21=0.088847818743090689935*reg127; reg25=0.088847818743090689935*reg124; reg17=reg18+reg17; reg18=0.005384432036113586778*reg124;
   reg33=0.021537728144454347112*reg127; reg34=0.021537728144454347112*reg124; reg136=reg57*reg136; reg24=reg57*reg24; reg120=reg119+reg120;
   reg38=0.009463616120767210603*reg124; reg7=reg121*reg7; reg133=reg89*reg133; reg8=reg134-reg8; reg128=reg130+reg128;
   reg40=0.005384432036113586778*reg127; reg37=reg70+reg37; reg99=reg109+reg99; reg21=reg34+reg21; reg12=reg18+reg12;
   reg18=reg40+reg18; reg42=0.009463616120767210603*reg8; reg43=0.021537728144454347112*reg8; reg25=reg33+reg25; reg45=0.005384432036113586778*reg8;
   reg33=reg34+reg33; reg40=reg38+reg40; reg34=0.088847818743090689935*reg8; reg24=reg120+reg24; reg136=reg17+reg136;
   reg7=reg133-reg7; reg128=reg123*reg128; reg37=reg99*reg37; reg93=reg137+reg93; reg17=0.016449618187943419918*reg7;
   reg34=reg33+reg34; reg128=reg37-reg128; reg40=reg40+reg45; reg93=reg24*reg93; reg42=reg18+reg42;
   reg25=reg25+reg43; reg18=0.028457289286966203713*reg7; reg24=0.0018441552587796664112*reg7; reg33=0.0041124045469858549794*reg7; reg12=reg45+reg12;
   reg136=reg112*reg136; reg21=reg43+reg21; reg21=reg17+reg21; reg24=reg25+reg24; reg25=0.0018441552587796664109*reg128;
   reg37=0.016449618187943419918*reg128; reg38=0.016449618187943419916*reg128; reg43=0.004112404546985854979*reg128; reg40=reg18-reg40; reg136=reg93-reg136;
   reg18=0.028457289286966203713*reg128; reg12=reg12+reg33; reg42=reg33+reg42; reg33=0.0041124045469858549794*reg128; reg17=reg34+reg17;
   reg34=0.028457289286966203713*reg136; reg33=reg42+reg33; reg12=reg18-reg12; reg25=reg21+reg25; reg18=0.0018441552587796664111*reg136;
   reg37=reg24+reg37; reg21=0.016449618187943419918*reg136; reg43=reg40-reg43; reg24=0.0041124045469858549794*reg136; reg38=reg17+reg38;
   Ne(0,15)+=reg21+reg25; Ne(1,16)+=reg21+reg25; Ne(2,17)+=reg21+reg25; Ne(0,6)+=reg34-reg33; Ne(1,7)+=reg34-reg33;
   Ne(2,8)+=reg34-reg33; Ne(0,0)+=reg43-reg24; Ne(1,1)+=reg43-reg24; Ne(2,2)+=reg43-reg24; Ne(0,12)+=reg37+reg21;
   Ne(1,13)+=reg37+reg21; Ne(2,14)+=reg37+reg21; Ne(0,9)+=reg38+reg18; Ne(1,10)+=reg38+reg18; Ne(2,11)+=reg38+reg18;
   Ne(0,3)+=reg12-reg24; Ne(1,4)+=reg12-reg24; Ne(2,5)+=reg12-reg24;
