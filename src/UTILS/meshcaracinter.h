...
public:
    ...
    struct NodalStaticData {
        ...
        void dm_data_set_field( const std::string field_name, const Mat<Tpos,Gen<1> > &value ) { assert(0); /*TODO*/ }
        void dm_data_set_field( const std::string field_name, const Mat<Tpos,Gen<2> > &value ) { assert(0); /*TODO*/ }
        void dm_data_set_field( const std::string field_name, const Mat<Tpos,Gen<3> > &value ) { assert(0); /*TODO*/ }
        void dm_data_set_field( const std::string field_name, const Mat<Tpos,Gen<4> > &value ) { assert(0); /*TODO*/ }
        void dm_data_set_field( const std::string field_name, const Mat<Tpos,Gen<5> > &value ) { assert(0); /*TODO*/ }
        void dm_data_set_field( const std::string field_name, const Mat<Tpos,Gen<6> > &value ) { assert(0); /*TODO*/ }
