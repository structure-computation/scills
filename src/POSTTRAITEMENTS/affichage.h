...
template <class TV3> void affichage_resultats(TV3 &S,  Param &process) __attribute__((noinline));
...
template <class TV3,class TV2> void affichage_energie(TV3 &S,TV2 &Inter, Param &process) __attribute__((noinline));
